...
- P8.4 workspace ablation is shadow-only through `STS2_P8_WORKSPACE_ABLATION_MODE=full|compact|ultra_compact`. Compact modes reduce nested workspace size and repeat allowed candidate ids at the prompt tail; they do not alter live prompt/candidates/scoring/fallback/validation/execution.
