...
{
    [Fact]
    public void ExecutionReadinessUsesExactPlayerEnvironmentIdentityNotLegacyBusinessPermission()
    {
    ...
    {
        Assert.Equal("1.0-rc.1", PlayerEnvironmentContract.ProtocolVersion);
    ...
    public void ReadOnlyDetailContractsArePlayerEnvironmentAndStateBound()
    {
        ...
        Assert.True(McpMod.IsSafePlayerEnvironmentReadIdentifier("read:run_deck"));
        Assert.True(McpMod.IsSafePlayerEnvironmentReadIdentifier("read:surface_card:card-a"));
        Assert.False(McpMod.IsSafePlayerEnvironmentReadIdentifier("run_deck"));
        Assert.False(McpMod.IsSafePlayerEnvironmentReadIdentifier("read:../hidden"));
        Assert.False(McpMod.IsSafePlayerEnvironmentReadIdentifier("read:"));
    }
