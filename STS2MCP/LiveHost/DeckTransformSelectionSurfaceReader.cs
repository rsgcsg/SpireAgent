...
/// </summary>
internal sealed class DeckTransformSelectionSurfaceReader : ILiveSurfaceReader
{
        ...
        out string? error)
    {
        ...
        if (context is EventLiveContext eventContext
        ...
        IReadOnlyList<string> missing)
    {
        return NativeUiFailClosedObservation.BindingUnavailable(
            ...
            "gateway.surface.deck_transform.binding_unavailable",
