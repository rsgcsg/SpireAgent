...
POST /api/he/evidence/native-pages/sessions
GET  /api/he/evidence/native-pages/sessions/{session_id}
POST /api/he/evidence/native-pages/sessions/{session_id}/return|recover
```
