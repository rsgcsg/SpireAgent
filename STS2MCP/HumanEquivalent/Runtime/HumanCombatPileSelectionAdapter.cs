...
internal static class HumanCombatPileSelectionAdapter
{
        ...
        GameBuildIdentity game)
    {
        ...
        return new BridgeObservationDraft(
            ...
            Warnings: new[]
            {
                "The opening source and eventual pile mutation are intentionally not inferred by Human-Equivalent C."
            },
    ...
    private static BridgeActionStartResult Rejected(string detail) =>
