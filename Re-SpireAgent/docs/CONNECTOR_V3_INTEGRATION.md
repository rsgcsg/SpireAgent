...
Direct combat commands (`play_card`, `use_potion`, `end_turn`) resolve current
native objects from V3 entity IDs and call native legality and Commit paths.
Non-combat candidates temporarily reuse mature Provider-native bindings inside
