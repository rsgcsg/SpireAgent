...
Re strictly accepts `3.0-preview.3` observations and receipts. It preserves:
...
| combat commands | direct V3 resolver and direct Re consumer | Gateway/Re tests plus 11 protocol-rewritten saved-snapshot checks | native commands exercised under Preview.2; direct consumer pending Preview.3 cold load |
...
| generated card choice | source-discriminated native resolver and direct Re consumer | source/owner/screen/card/control tests | predecessor Skill Potion adapter exercised; direct consumer pending Preview.3 cold load |
...
Ordinary combat, generated-card choice, main/singleplayer/character menus,
