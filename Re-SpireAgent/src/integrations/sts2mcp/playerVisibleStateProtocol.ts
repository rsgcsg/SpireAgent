...
export const persistentVisibleStateSchema = z.object({
...
export type PlayerVisibleCard = z.infer<typeof visibleCardSchema>;
export type PlayerVisibleRelic = z.infer<typeof visibleRelicSchema>;
export type PlayerPersistentVisibleState = z.infer<typeof persistentVisibleStateSchema>;
