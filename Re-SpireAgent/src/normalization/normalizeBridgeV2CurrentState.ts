...
function projectCombatPileCardSelectionSurface(
  ...
  return {
    ...
    sourceEntityKind: surface.source_entity_kind ?? "card",
    sourceEntityId: surface.source_entity_id ?? surface.source_card_entity_id!,
    sourceDefinitionId: surface.source_definition_id ?? surface.source_card_definition_id!,
