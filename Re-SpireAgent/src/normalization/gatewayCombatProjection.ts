...
import type { GatewayCombatContext } from "../integrations/sts2mcp/gatewayCombatProtocol.js";
import { projectGatewayVisibleCard } from "./gatewayVisibleStateProjection.js";

export function projectGatewayCombatContext(context: GatewayCombatContext): SemanticContext {
  return {
    kind: "combat",
...
export function projectGatewayCombatPlayer(
