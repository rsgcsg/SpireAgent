# Human Environment Clean-Baseline Plan
...
-> Authority admit environment/controller/request
-> HumanEnvironment publish snapshot/reads/bound actions
...
- Human Environment public records import no retired protocol types.
- Re production startup directly selects the HE adapter, strict decoder,
...
1. Gateway tests and Release build against the exact discovered game install.
...
6. `he_pure` ordinary Live run covering Observe/Read/Interact and stale refusal.
