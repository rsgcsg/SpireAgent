...
export const P8_WORKSPACE_SHADOW_DECISION_CLASSES_FLAG = "STS2_P8_WORKSPACE_SHADOW_DECISION_CLASSES";
...
export const P8_WORKSPACE_REVISION = "2026-07-05-v5.1.7-survival-cue-preservation";
