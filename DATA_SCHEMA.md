...
- These current fields mostly describe workspace-call budget. Future schema evolution should distinguish call budget, recovery budget, run budget, evidence budget, and rollout budget without weakening compatibility. See `BUDGET_GOVERNANCE.md`.
