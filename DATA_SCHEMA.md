...
- P9 may introduce `BudgetPolicyProposal` schema/proposal-only records. Those records must not apply budget changes by themselves. Runtime Budget/Compute OS behavior belongs to P13 or later guarded phases after proposal review, shadow validation, stable-promotion gates, and rollback exist.
