...
`1.0-preview.4`. Connector V3 remains an explicit rollback implementation and
...
-> current state-bound UI affordances (subject/arguments are public; native operands remain C-local)
